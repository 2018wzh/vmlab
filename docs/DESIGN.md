...
- **Axios**: HTTP请求处理
- **Vuex**: 状态管理
+ **Django Templates**: 使用Django模板语言进行页面渲染和模板继承
+ **Django Forms**: 后端表单处理与验证
+ **Django REST Framework**: 提供REST API，并供前端使用HTMX或JavaScript集成
...
### 2.1 布局结构
- 使用 Bootstrap 5 栅格系统实现响应式布局
- 左侧 Sidebar（固定宽度）包含导航菜单
- 右侧主内容区（自适应宽度）显示页面主体
